...
export default function Footer() {
  return (
    <footer role="contentinfo" className="bg-oceanic-noir border-t border-forsythia/10 py-16 sm:py-20">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {productLinks.map((link) => (
                <li key={link}>
                  <a href="#" className="flex items-center gap-1.5 text-sm text-mystic-mint/70 hover:text-forsythia transition-colors duration-150">
